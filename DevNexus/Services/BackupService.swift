...
final class BackupService {
    static let defaultFilename = "devnexus-backup"
    ...
    static func payload(from data: Data) throws -> DevNexusBackupPayload {
        try DevNexusBackupDocument(data: data).payload
    }
